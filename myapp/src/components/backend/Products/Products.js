...
export default function Products() {
    ...
    const columns = [
      ...
      { name: "product_Price",      label: "Giá",               options: { filter: true, sort: false, 
        ...
        let pricess = Number(`${items[tableMeta.rowIndex].product_Price}`) ;
        return pricess.toLocaleString('vi-VN', {
          style: 'currency',
          currency: 'VND'
      });
      }}},
    ...
    return (
      ...
      // </div> : <MustLogin/>
      <div>
        <nav className="sb-topnav navbar2 navbar-expand navbar-dark bg-dark">
          {/* Navbar Brand*/}
